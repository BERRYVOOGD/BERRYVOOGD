...
##   $ docker build -t berryvoogd-berryvoogd .
##
## RUNNING
##   $ docker run -p 9000:9000 berryvoogd-berryvoogd
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="hbuplbp" \
    STACKSMITH_STACK_NAME="BERRYVOOGD/BERRYVOOGD" \
